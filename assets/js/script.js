...
const slides = [
    {pic:'./assets/img/01.webp'}, //0
    {pic:'./assets/img/02.webp'}, //1
    {pic:'./assets/img/03.webp'}, //etc
  ...
  for (let i = 0; i < slides.length; i++) {
    ...
    /* ./assets/img/${member.img} */
    
    // for each slide we create the markup
    const slideMarkup = `<img class="${activeSlide === i ? 'active' : '' }" src="./assets/img/${slidePath}" alt="">`;
